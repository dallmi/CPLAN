...
$manifest = @(
    ...
    @{ Path = "pipeline\studio\app.js";        Marker = "centerSub";                         Why = "kit pass: neutral KPI tones, unified donut centres" },
    @{ Path = "pipeline\studio\styles.css";    Marker = "kit-pass";                          Why = "kit pass: sentence case, grey eyebrows, palette focus ring" },
