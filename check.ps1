...
$manifest = @(
    ...
    @{ Path = "pipeline\studio\app.js";        Marker = "kpiGroup";                       Why = "Overview steering tiles, jump links, coverage denominators" },
    @{ Path = "pipeline\studio\styles.css";    Marker = "kpi-groups";                       Why = "Overview collection cards, contrast-safe greys, jump-link style" },
    @{ Path = "pipeline\studio\index.html";    Marker = "overview-new";               Why = "create CTA on Overview, Quality & Coverage tab, planner blocks under Planning" },
