...
$manifest = @(
    ...
    @{ Path = "pipeline\studio\app.js";        Marker = "snapshotMode";                  Why = "four-tab studio, pack drawer, Excel exports, and the read-only snapshot switch" },
    @{ Path = "pipeline\studio\styles.css";    Marker = "channel-chip";                  Why = "channel colour, packs table, pack drawer, five-tile row" },
    @{ Path = "pipeline\studio\index.html";    Marker = "snapshot.js";                   Why = "four-tab nav, view switcher, pack drawer, both Excel exports, snapshot script tag" },
